module.exports = (client) => {
	...
	client.on('guildMemberAdd', (member) => updateMembers(member.guild)); console.log('Join Update Member');
	client.on('guildMemberRemove', (member) => updateMembers(member.guild)); console.log('Leave Update Member');
